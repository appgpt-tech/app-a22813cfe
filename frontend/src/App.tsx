...
import { DietList, DietCreate, DietEdit } from './resources/Diet';
import {
  ExerciseList,
  ExerciseCreate,
  ExerciseEdit,
} from './resources/Exercise';
import DietIcon from '@mui/icons-material/Fastfood';
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a22813cfe">
      <Admin
        authProvider={
